...
#  converted to a string, it would be: "rw-r-----" 755 is read/write/execute for the owner,  and read/execute for
#  group and others; converted to a string, it would be: "rwxr-xr-x" Fill in the blanks
#  to make the code convert a permission in octal format into a string format.
